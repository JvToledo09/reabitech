...
class Lesao(models.Model):
    ...
    fisioterapeuta_responsavel = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='lesoes_atendidas')
...
class EvolucaoFisica(models.Model):
    ...
    def percentual_recuperacao(self):
        return int(((10 - self.dor) + (10 - self.fadiga) + self.desempenho) / 30 * 100)